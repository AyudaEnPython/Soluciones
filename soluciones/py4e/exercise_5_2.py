...
try/except y envíe un mensaje apropiado e ignore el número. Ingrese
7, 2, bob, 10 y 4 y haga coincidir la salida a continuación.
"""
...
print(f"Máximo es {max(numeros)}")
print(f"Mínimo es {min(numeros)}")