...
probar el programa (la paga debe ser 498.75). Debes utilizar "input"
para leer una cadena y "float" para convertir la cadena en un número.
...
números correctamente. No nombre su variable "sum" o use la función
"sum".
"""
