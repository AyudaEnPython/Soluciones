...
sol = lambda arr: [[int(str(n)[0]) for n in row] for row in arr]
#sol = lambda arr: [[n//100 for n in row] for row in arr]
#sol = lambda arr: [[int(n / pow(10, int(log10(n)))) for n in row] for row in arr]
