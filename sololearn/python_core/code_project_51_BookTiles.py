...
You are provided a books.txt file, which includes the book titles, each
one written on a separate line.
...
NOTE: Recall the readlines() method, which returns a list containing
